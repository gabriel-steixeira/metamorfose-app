...
> **Para eventos e demonstrações rápidas, consulte o [Guia de Instalação Rápida](./INSTALACAO_RAPIDA.md)**

O projeto está pronto para uso em eventos! Todas as chaves de API necessárias já estão configuradas.
...
- Firebase (Authentication, Firestore, Storage) - **Já configurado**
- Google Maps API - **Já configurado**
- Gemini AI API - **Já configurado**
